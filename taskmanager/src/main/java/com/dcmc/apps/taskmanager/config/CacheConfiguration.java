...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, com.dcmc.apps.taskmanager.domain.WorkGroup.class.getName() + ".projects", jcacheConfiguration);
            createCache(cm, com.dcmc.apps.taskmanager.domain.WorkGroup.class.getName() + ".tasks", jcacheConfiguration);
            createCache(cm, com.dcmc.apps.taskmanager.domain.WorkGroup.class.getName() + ".users", jcacheConfiguration);
            createCache(cm, com.dcmc.apps.taskmanager.domain.WorkGroupUserRole.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, com.dcmc.apps.taskmanager.domain.Task.class.getName() + ".assignedTos", jcacheConfiguration);
